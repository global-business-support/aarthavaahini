...
function LoginPage() {
  ...
  const signUp = async (e: React.FormEvent) => {
    ...
    setLoading(false);
    if (error) return toast.error(error.message);
    toast.success("Account ban gaya! Email check karke verify kare.");
  };
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto flex flex-1 items-center justify-center px-6 py-16">
        <Card className="w-full max-w-md p-7 shadow-elegant">
          <h1 className="font-display text-3xl font-bold text-center">Aarthvaahini Account</h1>
          <p className="mt-1 text-center text-sm text-muted-foreground">Login ya naya account banaye</p>
